...
struct YOLOPrediction {
    ...
    let label: String
    var classIndex: Int {
        return YOLOPrediction.labelToIndex[label] ?? -1
    }

    private static let labelToIndex: [String: Int] = [
        "A♠": 0, "2♠": 1, "3♠": 2, "4♠": 3, "5♠": 4,
        "6♠": 5, "7♠": 6, "8♠": 7, "9♠": 8, "10♠": 9,
        "J♠": 10, "Q♠": 11, "K♠": 12
    ]
}
class VisionObjectRecognitionViewController_old: ViewController {
    ...
    func createTextSubLayerInBounds(_ bounds: CGRect, identifier: String, confidence: VNConfidence) -> CATextLayer {
        ...
        let largeFont = UIFont(name: "Helvetica", size: 8.0)!
