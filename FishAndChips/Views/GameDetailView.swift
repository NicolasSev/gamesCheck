...
struct GameDetailView: View {
    ...
    private func shareGameLink() {
        ...
        let webLink = "https://nicolassev.github.io/gamescheck/game.html?id=\(gameId)"
        ...
        📋 Или скопируйте код: \(gameId)
        и вставьте в приложении: Профиль → Мои заявки → Присоединиться
        """
